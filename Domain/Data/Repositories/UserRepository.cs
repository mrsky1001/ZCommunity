...
namespace Domain.Data.Repositories
{
    public class UserRepository : Repository<User>, IUserRepository
    {
        ...
        public User GetBy(int id, bool includeProfile = false, bool includeMessages = false,
            bool includeFollowers = false, bool includeFollowing = false)
        {
            var query = BuildUserQuery(includeProfile, includeMessages, includeFollowers, includeFollowing);
            return query.SingleOrDefault(u => u.Id == id);
        }

        private IQueryable<User> BuildUserQuery(bool includeProfile, bool includeMessages, bool includeFollowers, bool includeFollowing)
        {
            ...
            if (includeMessages)
                query = DbSet.Include(u => u.Messages);
        ...
        public User GetBy(string username, bool includeProfile = false, bool includeMessages = false, bool includeFollowers = false, bool includeFollowing = false)
        {
            var query = BuildUserQuery(includeProfile, includeMessages, includeFollowers, includeFollowing);
